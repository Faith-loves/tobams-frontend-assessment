...
export default function FooterOffices() {
  return (
    <div className="flex h-auto w-full min-w-0 rotate-0 flex-col gap-[24px] py-[20px] opacity-100">
      <div className="flex flex-col lg:flex-row h-auto w-full min-w-0 rotate-0 gap-[24px] rounded-[8px] bg-[#FFFFFF0F] p-[16px] md:p-[24px] opacity-100">
        <section aria-labelledby="registered-offices-heading" className="order-2 lg:order-none flex lg:flex-1 h-auto w-full min-w-0 flex-col gap-[10px]">
          ...
          <div className={`${nunitoSans.className} flex flex-col md:flex-row h-auto w-full min-w-0 gap-[24px] text-[14px] md:text-[16px] leading-[150%] tracking-[0] text-[var(--Hue-White,#FFFFFF)]`}>
            <p className="h-auto w-full min-w-0 md:flex-1 font-normal">
            ...
            <div aria-hidden="true" className="hidden md:block relative h-auto w-0 shrink-0 opacity-[0.12] before:absolute before:inset-y-0 before:left-[-0.5px] before:border-l before:border-[var(--shades-purple-selection-purple-10,#DDD0DA)] before:content-['']" />
            <p className="h-auto w-full min-w-0 md:flex-1 font-normal">
        ...
        <div aria-hidden="true" className="hidden md:block relative h-auto w-0 shrink-0 opacity-[0.12] before:absolute before:inset-y-0 before:left-[-0.5px] before:border-l before:border-[var(--shades-purple-selection-purple-10,#DDD0DA)] before:content-['']" />
        <section aria-labelledby="contact-information-heading" className="order-1 lg:order-none flex h-auto w-full lg:w-[254px] lg:shrink-0 min-w-0 flex-col gap-[17px]">
          ...
          <div className="flex h-auto w-full min-w-0 flex-col gap-[12px]">
            <a href="mailto:theteam@tobamsgroup.com" className="flex h-auto w-full min-w-0 gap-[16px]">
