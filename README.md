...
- Some exact source icons were not available in the supplied assets, so visually equivalent Lucide icons were used for the Account control, social links, navigation chevrons, and action icons. The supplied logo file contains a large transparent canvas; its visible artwork was framed within that canvas because applying the Figma dimensions to the entire source image made the logo appear too small.
